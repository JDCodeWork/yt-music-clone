...
import { SEARCH_HISTORY } from "@/shared/data/search.data";
...
export const SearchBar = () => {
  ...
  return (
    <label
      className="px-6 py-2 flex relative gap-4 items-center bg-stone-600/25 border border-stone-600 rounded-lg w-lg group/search hover:bg-stone-600/50 transition-[border-color] cursor-pointer has-focus:rounded-b-none has-focus:bg-stone-950 has-focus:cursor-default"
    >
