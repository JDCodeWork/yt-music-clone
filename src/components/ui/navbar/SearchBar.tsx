...
export const SearchBar = () => {
  ...
  return (
    <label
      className="px-6 py-2 flex relative gap-4 items-center bg-stone-600/35 border border-stone-600 rounded-xl w-1/2 group hover:bg-stone-600/50 transition-[border-color] cursor-pointer has-focus:rounded-b-none has-focus:bg-stone-950 has-focus:cursor-default"
    >
      ...
      <div className="hidden peer-focus:block absolute inset-x-0 scale-x-[1.005] right-0 top-[101%] py-8 items-center pr-2 bg-stone-950 rounded-b-xl border border-stone-600 shadow-lg">
      </div>
    </label>
  )
}